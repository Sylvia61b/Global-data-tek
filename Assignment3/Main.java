...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("8. Show Tasks in Increasing Order by Task Title");
            System.out.println("9. Show Tasks in Decreasing Order by Task Title");
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    scanner.nextLine();
                    user.deleteTaskById(idToDelete);
                    break;
                case 6:
                ...
                case 10:
                    ...
                    user.updateTask(idToUpdate, newTask);
                    break;
                default:
